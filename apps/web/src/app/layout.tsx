  ...
  return (
    <html lang="en" className="light" suppressHydrationWarning>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Alex+Brush&family=Anton&family=Birthstone&family=Cinzel:wght@400;500;600;700;800;900&family=DM+Sans:ital,opsz,wght@0,9..40,100..1000;1,9..40,100..1000&family=Great+Vibes&family=Inter:wght@400;500;600;700&family=Italiana&family=Marcellus&family=Outfit:wght@300;400;500;600;700;800&family=Parisienne&family=Playfair+Display:ital,wght@0,400;0,600;0,700;1,400&family=Tenor+Sans&display=swap"
          rel="stylesheet"
        />
